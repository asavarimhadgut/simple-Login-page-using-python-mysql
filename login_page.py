...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "Team 3:", font=("times new roman", 30, "bold"), bg="yellow", fg="red").place(x=50,y=300)
        label2 = Label(self.frame1, text= "Visionaries", font=("times new roman", 30, "bold"), bg="yellow", fg="RoyalBlue1").place(x=200,y=300)
        label3 = Label(self.frame1, text= "CDAC", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
